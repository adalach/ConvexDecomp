...
try:
    from .polygon_convexity import is_convex_polygon, raw_ring_key
except Exception:
    from notebooks.helpers.polygon_convexity import is_convex_polygon, raw_ring_key
...
def open_concave_room_polygons(
    ...
    *,
    ...
    normalize_plan: Optional[Callable[[Dict[str, Any]], Dict[str, Any]]] = None,
    graph_builder: Optional[Callable[[Dict[str, Any]], Any]] = None,
...
def grow_rooms_by_stored_wall_thickness(
    ...
    *,
    ...
    for plan in plans:
        ...
        if graph_builder is not None:
            plan_out["graph"] = graph_builder(plan_out)
