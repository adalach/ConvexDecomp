...
def symmetric_opening(geom: BaseGeometry | None, distance_m: float, *, join_style: int) -> BaseGeometry | None:
    ...
    # Shrink-then-reopen removes tiny inward notches while roughly preserving the outer shell.
    try:
    ...
    *,
    ...
    for inner_segment in inner_segments:
        ...
        for parent_segment in parent_segments:
            # The matching is intentionally local: parallelism plus offset distance, not full shape registration.
