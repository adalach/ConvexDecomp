...
from convexdecomp.core.convexity import polygon_turn_crosses, raw_ring_key
...
def run_adaptive_search(
    *,
    ...
    while True:
        ...
        # Depth grows before width so the retry path stays comparable across datasets.
        if depth < max_depth:
...
def run_polygon_state_search(
    ...
    *,
    ...
    # These three pools let the search trim width locally without discarding stronger states forever.
